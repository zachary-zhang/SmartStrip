 ...
 *  取得设备唯一标识
 */
-(void)didGetIdentifierForApp
{
    NSString *identifierStr = [[[UIDevice currentDevice] identifierForVendor] UUIDString];
    NSString * const KEY_USERNAME_PASSWORD = @"com.manbu.smartstrip.usernamepassword";
    NSString * const KEY_PASSWORD = @"com.manbu.smartstrip.password";
